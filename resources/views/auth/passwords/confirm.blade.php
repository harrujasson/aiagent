                                    ...
                                    <div class="my-auto">
                                        ...
                                        <div class="mt-4">
                                            ...
                                            <div class="mt-5 text-center">
                                                <p>Remember It ? <a href="{{ url('subscriber-login') }}"
    ...
    @section('script')
        ...
        <script>
            document.addEventListener("DOMContentLoaded", function () {
                ...
                const linkElement = document.getElementById('subscriberLoginLink');
                
                let baseUrl;
                if (storenumber && storenumber !== 'null' && storenumber.trim() !== '') {
                    baseUrl = "{{ url('subscriber-login') }}";
                } else {
                    baseUrl = "{{ url('login') }}";
                }

                if (linkElement) {
                    linkElement.href = storenumber 
                        ? `${baseUrl}?storenumber=${storenumber}` 
                        : baseUrl;
                } else {
                    console.error("Link element with ID 'subscriberLoginLink' not found.");
                }
            });
