    ...
    <div class="col-12 col-xl-6">
        <div class="card overflow-hidden profile-card">
            ...
            <div class="card-body pt-0">
                <div class="row">
                    <div class="col-sm-4">
                        <div class="avatar-md profile-user-wid mb-3 staff-user-profile">
                            @if(!empty($r->picture))
                        ...
                        <p class="text-muted mb-0 text-truncate">{{$r->role_type}}</p>
                    </div>
                ...
                <div class="row mt-3">
                    <div class="col">
                        <div class="btn-set">
                            <a href="{{route('staff.profile-edit')}}" class="btn btn-primary-soft btn-rounded"><i class="ti ti-pencil-minus"></i> Edit
                                Profile</a>
                        </div>
                    </div>
                </div>
