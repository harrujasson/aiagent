...
<div class="row">
    <div class="col-lg-12 col-md-12 mx-auto">
        ...
        <div class="card">
            ...
            <form class="needs-validation" novalidate method="post" action="{{ route('staff.my_profile_save',$r->id) }}"  enctype="multipart/form-data">
            @csrf
                <div class="card-body">
                ...
                <div class="card-footer">
                    <div class="d-flex space-between align-center">
                        <a href="{{route('staff.profile')}}" class="btn btn-transparent btn-rounded"><i class="ti ti-arrow-left"></i> Back</a>
