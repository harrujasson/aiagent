...
Route::group(['prefix' => 'admin', 'as' => 'admin.','middleware'=>['auth','admin_manager']], function () {
    ...
    Route::get('test', ['as'=>'test', 'uses'=>'App\Http\Controllers\Admin\ReportController@test']);
    /*Vendors*/
    ...
    Route::group(['prefix'=>'report','as'=>'report.'],function(){
        Route::get('show',['as'=>'show','uses'=>'App\Http\Controllers\Admin\ReportController@show']);
        Route::post('query',['as'=>'query','uses'=>'App\Http\Controllers\Admin\ReportController@user_query']);
    });
});
